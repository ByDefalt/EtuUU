...
public class GestionEtudiant implements InterEtudiant, Serializable, Cloneable {
   ...
   */
  @Override
  public int inscription(InformationPersonnelle informationPersonnelle,
      String motDePasse) {
    if (motDePasse == null || motDePasse.isEmpty()
        || informationPersonnelle == null) {
      return -1;
    }
   ...
   *
   * @param listeUE La liste des unités d'enseignement à attribuer à un
   *        étudiant.
   */
  ...
  /**
   * Ajoute le nombre d'options que les étudiants d'une formation doivent
   * choisir.
   *
   * @return le nombre d'options que les étudiants d'une formation doivent
   *         choisir
   */
  ...
  public boolean choisirOption(UniteEnseignement ue)
    ...
    if (ue.getnbParticipant() < ue.getNbPlacesMax() && ue.getOptionnel()
        && this.etudiantConnecte
            .getNbOptionListeUeSuivies() < this.etudiantConnecte.getNbOption()
        && ue != null) {
  ...
  public int nombresOptionsChoisi() throws NonConnecteException {
    ...
    Set<UniteEnseignement> ueCommun =
        new HashSet<>(this.etudiantConnecte.getListeUEsuivies());
  ...
  public boolean inscriptionFinalisee() throws NonConnecteException {
    ...
    return etudiantConnecte.getNumeroTd() != -1
        && etudiantConnecte.getNumeroTp() != -1
  ...
  public String toString() {
    return "GestionEtudiant [nbEtudiant=" + nbEtudiant + ", listeEtudiants="
        + listeEtudiants + ", listeUE=" + listeUE + ", etudiantConnecte="
        + etudiantConnecte + "]";
  }
