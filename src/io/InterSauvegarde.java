...
/**
 * Définit les méthodes permettant de sauvegarder les données dans un fichier.
 *
 * @author Eric Cariou
 */
public interface InterSauvegarde {
  ...
  /**
   * Sauvegarde toutes les données de la formation : liste des UEs, des
   * étudiants et des groupes.
   *
  ...
  /**
   * Charge les données de la formation (UEs, étudiants, groupes) à partir d'un
   * fichier.
   *
