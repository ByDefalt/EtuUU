 ...
 * fonctionnement des fonctionnalités de la classe {@link formation.Etudiant}.
 *
...
class TestEtudiant {
  ...
  /**
   * Test de la méthode {@link Etudiant#setNumero(int)} et
   * {@link Etudiant#getNumero()}. Vérifie que l'on peut positionner le numero
   * 123.
   */
  @Test
  void testNumero() {
  ...
  /**
   * Test de la méthode {@link Etudiant#addUE(UniteEnseignement)}. Vérifie que
   * l'on peut ajouter une ue optionnelle.
   */
  @Test
  ...
  /**
   * Test de la méthode {@link Etudiant#addUE(UniteEnseignement)}. Vérifie que
   * l'on peut ajouter une ue obligatoire.
   */
  @Test
  ...
  /**
   * Test de la méthode {@link Etudiant#getListeUEsuivies()}. Vérifie que l'on
   * récupère bien toutes les ue suivies d'un etudiant.
   */
  @Test
  ...
  /**
   * Test de la méthode {@link Etudiant#getMessages()}. Vérifie que l'on
   * récupère bien tout les messages d'un etudiant.
   */
  @Test
  ...
  /**
   * Test de la méthode {@link Etudiant#clone()}. Vérifie que l'on clone bien
   * l'objet etudiant et que la méthode equals fonctionne.
   * 
