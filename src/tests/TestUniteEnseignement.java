...
class TestInformationUniteEnseignement {
  ...
  void testConstructeur() {
    ...
    assertThrows(IllegalArgumentException.class,
        () -> new UniteEnseignement("Informatique", null));
    assertThrows(IllegalArgumentException.class,
        () -> new UniteEnseignement(null, "Informatique"));
    assertThrows(IllegalArgumentException.class,
        () -> new UniteEnseignement(null, null));
  }
   ...
   * identiques, puis tente de cloner ue2 dans ue3 en utilisant la méthode
   * {@code clone()}.
   * 
